...
this["templates"]["home"] = Handlebars.registerPartial("home", Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1;
